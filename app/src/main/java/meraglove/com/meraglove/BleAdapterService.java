...
public class BleAdapterService extends Service {
    ...
    public static final String BATTERY_SERVICE_SERVICE_UUID = "180F";
    public static final String WEIGHT_SCALE_SERVICE_UUID = "181D";

    public static final String BATTERY_LEVEL_CHARACTERISTIC_UUID = "2A19";
    public static final String WEIGHT_SCALE_FEATURE_CHARACTERISTIC_UUID = "2A9E";
    public static final String WEIGHT_MEASUREMENT_CHARACTERISTIC_UUID = "2A9D";
