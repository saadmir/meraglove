...
import meraglove.com.meraglove.Constants;
import meraglove.com.meraglove.PeripheralControlActivity;
import meraglove.com.meraglove.ScanFilterFactory;
...
public class MainActivity extends Activity {
	...
	public void count(int counter) {
		...
		for (int a = 1; a <= counter ;a++) {
			Log.d(Constants.TAG, "a: " + String.valueOf(a));
